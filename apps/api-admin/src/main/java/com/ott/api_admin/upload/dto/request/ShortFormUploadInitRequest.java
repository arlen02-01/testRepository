...
@Schema(description = "숏폼 업로드 초기화 요청")
public record ShortFormUploadInitRequest(

        @Schema(type = "Long", description = "시리즈 ID (선택)", example = "1")
        Long seriesId,

        @Schema(type = "Long", description = "콘텐츠 ID (선택)", example = "1")
        Long contentsId,

        @Schema(type = "String", description = "숏폼 제목", example = "숏폼 1")
        @NotBlank
        String title,

        @Schema(type = "String", description = "숏폼 설명", example = "하이라이트 숏폼")
        @NotBlank
        String description,
        ...
        @Schema(type = "Integer", description = "러닝타임(초)", example = "60")
        Integer duration,

        @Schema(type = "Integer", description = "영상 크기(MB 등)", example = "128")
        Integer videoSize,
